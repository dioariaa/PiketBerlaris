  ...
  return (
    <div className="flex-1 bg-white rounded-xl border border-[#E8E8E8] p-3.5 min-w-0">
      ...
      <button
        ...
        disabled={uploading}
        className="w-full h-[72px] rounded-lg border-2 border-dashed border-[#D7CCC8] bg-[#F7F2EE] flex flex-col items-center justify-center gap-0.5 text-[#5D4037] active:bg-[#EFEBE9] disabled:opacity-50"
      >
        <span className="text-xl leading-none">📷</span>
        <span className="text-[11px] font-semibold">{uploading ? 'Mengupload...' : 'Ambil Foto'}</span>
      </button>
